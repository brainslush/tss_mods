...
[{!(cba_events_eventNamespace getVariable "itc_land_ar2i_onLoadTurretDisplay" isEqualTo [])}, {

    ["itc_land_ar2i_onLoadTurretDisplay", 0] call CBA_fnc_removeEventHandler;
    ...
    ["itc_land_ar2i_onLoadTurretDisplay", {
        [{
            ...
            if ( (cameraView != "GUNNER") || (_uavControlPos != "GUNNER") ) then {			
                ...
                private _startMemPoint = getText(configFile >> "CfgVehicles" >> _type >> "uavCameraGunnerPos");
                private _endMemPoint = getText(configFile >> "CfgVehicles" >> _type >> "uavCameraGunnerDir");
                private _start = _uav selectionPosition _startMemPoint;
                private _end = _uav selectionPosition _endMemPoint;
                private _weaponDirVector = _start vectorFromTo _end;
