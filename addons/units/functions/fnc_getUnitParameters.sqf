...
private _3denUnitBackpack = _unit getVariable [QGVAR(3denBackpack), ""];
private _3denBackpack = if (_3denUnitBackpack != "") then {""};
private _3denMuzzle = unit getVariable [QGVAR(3denMuzzle), ["fire", "silent"] select (_unitc in ["recon", "diver"])];
